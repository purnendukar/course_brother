			...
			<div class="main-content">
				...
				<a href="javascript:window.history.back();">Back</a>
                    ...
                    <div class='row menu-form'>
                        <div class='col-lg-6'>
                            <h2 class='menu-text'>Privacy Policy</h2>
                            <div id="tab" class='menu-content' style="width:100%">
                                <div class="form-group">
                                <?php $res=$conn_p->query("SELECT * FROM `policies` where id=5");?>
                                    ...
                                    <div style="margin:10px;text-align:center;"><input type="button" id="update_" class="btn btn-primary" value="Edit" onclick="update_('5',this);" /> <input style="display:none;" id='cancel_' type="button" class="btn btn-primary" value="Cancel" onclick="cancel();" /></div>
								</div>
