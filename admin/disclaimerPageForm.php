                    ...
                    <div class='row menu-form'>
                        <div class='col-lg-6'>
                            ...
                            <div id="tab" class='menu-content' style="width:100%">
                                ...
                                <?php $res=$conn_p->query("SELECT * FROM `policies` where id=3");?>
                                    ...
                                    <div style="margin:10px;text-align:center;"><input type="button" id="update_" class="btn btn-primary" value="Edit" onclick="update_('3',this);" /> <input style="display:none;" id='cancel_' type="button" class="btn btn-primary" value="Cancel" onclick="cancel();" /></div>
                                </div>
