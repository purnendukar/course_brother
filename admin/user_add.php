		...
		<div class="main-container ace-save-state" id="main-container">
            ...
            <div class='row menu-form'>
              <div class='col-lg-6' style="width:100%;">
                  ...
                  <form method="post" class='menu-content' action="javascript:edit_()" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      ...
                      <input name="f_name" type="text" class="form-control" style="min-heigth:500px;min-width:100%;max-width:100%;"placeholder="Full Name" value="" required>
                    </div>
                    <div class="form-group">
                      <label for="email">Email</label>
                      <input name="email" type="text" class="form-control" style="min-heigth:500px;min-width:100%;max-width:100%;"placeholder="Email" value="" required>
                    </div>
                    <div class="form-group">
                      ...
                      <div style="display:inline-block;font-size:15px;padding:5px;"><input name="pages" type="checkbox" value="blogAddForm,blogEditForm,blogEditFormShow" > Blog</div>
                      <?php $r=$conn_p->query("select * from universities");
                        while($t=$r->fetch_assoc()){
                      ?>
                      <div style="display:inline-block;font-size:15px;padding:5px;"><input name="pages" type="checkbox" value="newsletterall,newsletterEditForm?id=<?php echo $t['u_id']?>" > News & Update of <?php echo $t['u_name'];?></div>
                        <?php } ?>
                      ...
                      <div style="display:inline-block;font-size:15px;padding:5px;"><input name="pages" type="checkbox" value="institutionAddForm,institutionEditForm,institutionDeleteForm" > University Edit</div>
                      <div style="display:inline-block;font-size:15px;padding:5px;"><input name="pages" type="checkbox" value="courseAddForm,courseEditForm" > Course Edit</div>
                      <div style="display:inline-block;font-size:15px;padding:5px;"><input name="pages" type="checkbox" value="specialisation_add,specialisation_edit,specialisation_delete" > Specialisation Edit</div>
                    ...
                    <div class="form-group">
                      ...
                      <input name="city" type="text" class="form-control" style="min-heigth:500px;min-width:100%;max-width:100%;"placeholder="City" value="" required>
                    </div>
                    <div class="form-group">
                      <label for="addr">Address</label>
                      <input name="addr" type="text" class="form-control" style="min-heigth:500px;min-width:100%;max-width:100%;"placeholder="Address" value="" required>
                    </div>
                    <div class="form-group">
                      <label for="phn_no">Contact Number</label>
                      <input name="phn_no" type="text" class="form-control" style="min-heigth:500px;min-width:100%;max-width:100%;"placeholder="Contact Number" value="" required>
                    </div>
                    <div class="form-group">
                      <label for="pass">Password</label>
                      <input name="pass" type="text" class="form-control" style="min-heigth:500px;min-width:100%;max-width:100%;"placeholder="Password" value="" required>
                    </div>
