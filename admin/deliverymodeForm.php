        ...
        <script>
            function delete_(a){
                                    ...
                                    $.ajax({
                                        ...
                                        complete: function (data) {
                                            if(data.responseText==1){
                                                                                        ...
                                                                                        window.location.href="./deliverymodeForm";
                                        }
                                    });
                                }
                            }
                        ...
                        function send_data(id,s_name){
                            $.ajax({
                                type: "POST",
                                url: "./deliverymode_update.php",
                                data: {id:id,p_name:s_name.value},
                                complete: function(data){
						...
						function cancel_(a){
							...
							if(s_name.disabled==false){
								var formData= new FormData();
								formData.append('query','select * from delivery_mode where id='+a);
								$.ajax({
									url: "./get_info.php",
									type: 'POST',
									cache: false,
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				...
				<a href="javascript:window.history.back();">Back</a>
						...
						<div class="row">
								<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Delivery Mode dataTables</h3>

										<div class="clearfix">
											<div class="pull-right tableTools-container"></div>
										</div>
										<div class="table-header">
											Results Of Delivey Mode
										</div>
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<div style="background-color: #EFF3F8;padding:15px 15px 5px 15px;">
                                                    <a href='javascript:delete_checked()' class='tooltip-error ' data-rel='tooltip' title='Delete' >
														...
														<div id="add_one" class="form-group"  style="display:none;width:100%;text-align:center; padding:30px;">			
                                                            <textarea style="resize:none;width:100%;" type="text" name="input_" class="form-control" placeholder="Delivery Mode"></textarea>
												...
												"<tr id='row_".$row['id']."'>
														...
														<td>
                                                            <input name='".$row['id']."s_name' disabled style='width:100%;border:none;padding:5px;' value='".urldecode($row['d_mode'])."'/>
														</td>
