		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
                    ...
                    <div class='row menu-form'>
                        <div class='col-lg-6'>
                            <h2 class='menu-text'>Refund Policy</h2>
                            <div id="tab" class='menu-content' style="width:100%">
                                <div class="form-group">
                                <?php $res=$conn_p->query("SELECT * FROM `policies` where id=2");?>
                                    <div style="padding:5px"><b>Content : </b>
                                        <textarea style="min-width:100%;max-width:100%;height:100px;" class="form-control" name="input_" type="text" disabled><?php echo urldecode($res->fetch_assoc()['content']);?></textarea>
                                    </div>
                                    <div style="margin:10px;text-align:center;"><input id="update_" type="button" class="btn btn-primary" value="Edit" onclick="update_('2',this);" /> <input style="display:none;" id='cancel_' type="button" class="btn btn-primary" value="Cancel" onclick="cancel();" /></div>
                                </div>
