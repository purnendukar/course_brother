            ...
            <div class='col-lg-6' style="width:90%">
                  ...
                  <form class='menu-content'  method="post" action="">
                      <table>
                            ...
                            while($row=$res->fetch_assoc()){ echo "<tr class=\"form-group\" id='row".$row['id']."'>";
                          ?>
                          ...
                          <td><input name="<?php echo $row['id']."edit_update" ?>" type="button" class="btn btn-primary" style="width:80px" value="Delete" onclick="delete_('<?php echo $row['id'];?>');"/>
                          </td>
                            <?php echo"</tr>";}
                            ?>
                        </table>
