                        ...
                        <div class='col-lg-6'>
                            ...
                            <div id="tab" class='menu-content' style="width:100%">
                                ...
                                <?php $res=$conn_p->query("SELECT * FROM `policies` where id=1");?>
                                    ...
                                    <div style="margin:10px;text-align:center;"><input id="update_" type="button" class="btn btn-primary" value="Edit" onclick="update_('1',this);" /> <input style="display:none;" id='cancel_' type="button" class="btn btn-primary" value="Cancel" onclick="cancel();" /></div>
                                </div>
