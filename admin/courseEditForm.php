		...
		<script>
            function edit(a){
                if(confirm("Want to delete id "+a+"?")){
									if(confirm("Going to delete id "+a)){
										var f= new FormData();
										f.append('ind',a);
										$.ajax({
												...
												"<tr id='row_".$row['id']."'>
														...
														<td style='width:120px'>
															<div class='hidden-sm hidden-xs action-buttons'>
																...
																<a class='green' href='./courseEditFormShow?id=".$row['id']."' class='tooltip-success'>
																	<i class='ace-icon fa fa-pencil bigger-130'></i>
																</a>

																<a class='red' href='javascript:edit(".$row['id'].")' >
															...
															<div class='hidden-md hidden-lg'>
																<div class='inline pos-rel'>
																	...
																	<ul class='dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close'>
																		...
																		<li>
																			<a href='./courseEditFormShow?id=".$row['id']."' class='tooltip-success' data-rel='tooltip' title='Edit'>
																				<span class='green'>
																		...
																		<li>
																			<a href='javascript:edit(".$row['id'].")' class='tooltip-error' data-rel='tooltip' title='Delete' >
																				<span class='red'>
