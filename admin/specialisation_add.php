    ...
    $admin->query("INSERT INTO `user_activity`(`user_id`, `activity`) VALUES ('".$_COOKIE['user_id']."','added speicalisation ".$_POST['s_name']."')");
		...
		<div class="main-container ace-save-state" id="main-container">
            ...
            <div class='row menu-form'>
              <div class='col-lg-6'>
                  <h2 class='menu-text'>Specialisation Add Menu</h2>
                  <form method="post" class='menu-content' action="" enctype="multipart/form-data" >
                    <div class="form-group">
                      <label for="s_name">Specialisation Name</label>
                      <input name="s_name" type="text" class="form-control" placeholder="Specialisation Name" required>
                    </div>
